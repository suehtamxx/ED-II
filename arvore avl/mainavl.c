...
int main ()
{
    ...
    arv_curso_avl *arvCurso;
    arv_dis_avl *arvDis;
    arv_matri_avl *arvMatri;
    arv_notas_avl *arvNotas;
    l_aluno *lAluno;
    ...
    //Criando os nós
    arv_curso_avl *noCurso;
    arv_dis_avl *noDis;
    l_aluno *noAluno;
    arv_matri_avl *noMatri;
    ...
    do
    {
        ...
        printf("\n8. Imprimir Aluno");
        printf("\n9. Imprimir Disciplinas Por Periodo");
        printf("\n10. Imprimir Disciplinas Por Aluno");
        printf("\n11. Imprimir Notas de um Periodo de Aluno");
        printf("\n12. Imprimir Notas de uma Disciplina de Aluno");
        printf("\n13. Remover Disciplina do Curso");
        printf("\n14. Trancar Disciplina");
        printf("\n15. Imprimir Historico de Aluno");
        printf("\n0. Sair\n");
        ...
        case 2:
            ...
            if(noCurso != NULL)
            {
                ...
                if (noDis != NULL)
                {
                    ...
                    verificacao = inserir_arv_disciplina(&(noCurso->info.arv_dis_avl), noDis); //Inserindo na árvore o nó preenchido
        ...
        case 3:
            ...
            if (noCurso != NULL)
            {
                ...
                if (noAluno != NULL)
                {
                    ...
                    imprimir_arv_disciplina(noCurso->info.arv_dis_avl);
                    printf("\nInforme o codigo da disciplina: ");
                    scanf(" %[^\n]", busca);
                    
                    noDis = buscar_disciplina(noCurso->info.arv_dis_avl, busca); //Buscando o disciplina escolhido
                    if (noDis != NULL)
                    {
        ...
        case 5:
            ...
            if(noCurso != NULL)
            {
                ...
                noDis = buscar_disciplina(noCurso->info.arv_dis_avl, busca); //Buscando a disciplina escolhido
                if(noDis != NULL)
                {
                    printf("\n- Imprimindo alunos do curso:\n");
                    ...
                    if(noAluno != NULL)
                    {
                        ...
                        if(noMatri != NULL)
                        {
                            ...
                            if(noNota != NULL)
                            {
                                ...
                                verificacao = inserir_arv_notas(&noAluno->info.arv_notas_avl, noNota); //Inserindo na árvore o nó preenchido
        ...
        case 9:
            ...
            if(noCurso != NULL)
            {
                ...
                buscar_disciplina_periodo(noCurso->info.arv_dis_avl, &buscaInt);
            }
            else printf("\nCurso nao encontrado!\n");
        ...
        case 10:
            printf("\n===== IMPRIMINDO DISCIPLINAS P/ ALUNO =====\n");
            ...
            if(noCurso != NULL)
            {
                ...
                noAluno = buscar_aluno(lAluno, busca); //Buscando o aluno escolhido
                if (noAluno != NULL)
                    buscar_disciplina_matricula(noAluno->info.arv_matricula, noCurso->info.arv_dis_avl);
            }
            else printf("\nCurso nao encontrado!\n");
        ...
        case 11:
            ...
            if(noCurso != NULL)
            {
                ...
                if (noAluno != NULL)
                {
                    ...
                    buscar_notas_periodo(noAluno->info.arv_notas_avl, buscaSemestre);
        ...
        case 12:
            ...
            if(noCurso != NULL)
            {
                ...
                if(noDis != NULL)
                {
                    ...
                    noAluno = buscar_aluno(lAluno, busca); //Buscando a aluno escolhido
                    if(noAluno != NULL)
                        buscar_notas_disciplina(noAluno->info.arv_notas_avl, noDis);
        ...
        case 13:
            ...
            if(noCurso != NULL)
            {
                ...
                {
                    noDis = buscar_disciplina(noCurso->info.arv_dis_avl, busca);
                    if(noDis != NULL)
                    {
                        remover_disciplina_curso(&(noCurso->info.arv_dis_avl), noDis, lAluno);
                        printf("\nDisciplina Removida!\n");
                    }
                    else printf("\nErro ao remover disciplina!\n");
                }
                else printf("\nAinda ha alunos matriculados!\n");
            }
            else printf("\nCurso nao encontrado!\n");
        ...
        case 14:
            ...
            if(noCurso != NULL)
            {
                ...
                if(noDis != NULL)
                {
                    printf("\n- Imprimindo os alunos da disciplina:\n");
                    imprimir_alunos_disciplina(lAluno, noDis);
                    printf("\nInforme a matricula do aluno: ");
                    scanf(" %[^\n]", busca);
                    while(getchar() != '\n');
            ...
            noAluno = buscar_aluno(lAluno, busca);
            if (noAluno != NULL)
                historico_aluno(noAluno, arvCurso);
